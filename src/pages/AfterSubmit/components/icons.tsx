...
export const ClipboardIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="text-slate-400 group-hover:text-slate-600 transition-colors" viewBox="0 0 16 16">
