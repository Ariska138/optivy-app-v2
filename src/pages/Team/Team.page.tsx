...
const initialTeamMembers: ManagedTeamMember[] = [
  {
    ...
    role: TeamRole.Admin,
    avatarUrl: 'https://i.pravatar.cc/150?u=zaenal',
  },
  {
    id: 2,
    name: 'Dhea Mufni',
    email: 'dhea.m@email.com',
    role: TeamRole.Sales,
  ...
  },
  {
    id: 3,
    name: 'Antonion',
    email: 'antonio.dev@email.com',
    role: TeamRole.Advertiser,
    avatarUrl: 'https://i.pravatar.cc/150?u=antonion',
  },
  {
    id: 4,
    name: 'Budi Gudang',
    email: 'budi.gudang@email.com',
    role: TeamRole.Gudang,
...
const TeamPage: React.FC = () => {
  const [members, setMembers] =
    useState<ManagedTeamMember[]>(initialTeamMembers);
