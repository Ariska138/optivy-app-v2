...
export const OrderDetailView: React.FC<OrderDetailViewProps> = ({
  ...
  const renderMainContent = () => {
    switch (activeView) {
      ...
      default:
        return (
          <p className="p-6 bg-white rounded-2xl shadow-sm border border-gray-200">
            Tampilan untuk tipe '{activeView}' belum diimplementasikan.
          </p>
        );
    }
  };
    ...
    <div className="flex-1 flex flex-col bg-[#F8F7FA] text-[#1F2937]">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <main className="lg:col-span-2 space-y-6">{renderMainContent()}</main>
