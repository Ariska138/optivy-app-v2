...
// --- General App Types ---
export type PageType = 'dashboard' | 'orders' | 'products' | 'domains' | 'team' | 'integrations' | 'product-creation' | 'edit-profile' | 'discount-codes' | 'local-payments' | 'after-submit' | 'page-builder';
