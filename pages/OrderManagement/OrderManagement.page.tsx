...
import { digitalOrders, fisikOrders, lmsOrders, leadOrders } from '../../constants/data';
    ...
    const filteredData = useMemo(() => {
        ...
        if (searchTerm) {
            ...
            data = data.filter(item =>
                (item.customer && item.customer.toLowerCase().includes(lowercasedFilter)) ||
                ...
                ('product' in item && item.product && item.product.toLowerCase().includes(lowercasedFilter))
            );
        }
        if (filterDate) {
