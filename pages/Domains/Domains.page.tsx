        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-6 space-y-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                    <h2 className="text-xl font-bold text-gray-800">Subdomain Gratis Anda</h2>
                    <p className="text-gray-500 mt-1">Ini adalah domain utama Anda yang disediakan secara gratis.</p>
